...
class ESLintMate
  ...
  def self.config_path
    config_file = Pathname.new(ENV['HOME']).join('.eslint.yml').expand_path
...
ESLintMate.run do |offence_count|
  case offence_count
  when false
    TextMate::UI.tool_tip('Could not find node or eslint executable, please set TM_NODE and TM_SASS_LINT')
  when nil
